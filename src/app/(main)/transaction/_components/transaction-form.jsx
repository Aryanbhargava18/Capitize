    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        {errors.type && (
          ...
          >
            <SelectTrigger id="account" aria-label="Select account">
        ...
        {/* Recurring Settings */}
        <div className="space-y-4">
          <h2 className="text-lg font-semibold border-b pb-2">Recurring Settings</h2>
          ...
          <div className="flex flex-row items-center justify-between rounded-lg border p-4">
            ...
            <Switch
              ...
              aria-label="Enable recurring transaction"
            />
          </div>
          ...
          {isRecurring && (
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="recurringInterval" aria-label="Select recurring interval">
